...
<input type="text" name="a3" placeholder="Roll Numbar"required>
              <input type="text" name="fieldc" placeholder="Student 3" required>
<input type="text" name="a4" placeholder="Roll Numbar">
              <input type="text" name="fieldd" placeholder="Student 4" required>
<input type="text" name="a5" placeholder="Roll Numbar" required>
              <input type="text" name="fielde" placeholder="Student 5" required>
<input type="text" name="a6" placeholder="Roll Numbar" required>
